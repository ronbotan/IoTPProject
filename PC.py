...
def run():
	...
	ap.add_argument("-p", "--prototxt", required=False, default = prototxt,	help="path to Caffe 'deploy' prototxt file")
	ap.add_argument("-m", "--model", required=False, default = model, help="path to Caffe pre-trained model")
	ap.add_argument("-i", "--input", type=str, default = defaultvid, help="path to optional input video file")
